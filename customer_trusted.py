...
CustomerLanding_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://charlieudacitybucket/customer/landing/"],
        "recurse": True,
    },
...
PrivacyFilter_node1687875172878 = Filter.apply(
    frame=CustomerLanding_node1,
    f=lambda row: (not (row["shareWithResearchAsOfDate"] == 0)),
    transformation_ctx="PrivacyFilter_node1687875172878",
)

# Script generated for node CustomerTrusted
CustomerTrusted_node3 = glueContext.write_dynamic_frame.from_options(
    frame=PrivacyFilter_node1687875172878,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://charlieudacitybucket/customer/trusted/",
        "partitionKeys": [],
    },
